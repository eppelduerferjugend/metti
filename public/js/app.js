    ...
    _vm._l(_vm.orders, function(name, idTheatre) {
      return _c("div", [
        _c("input", {
          ...
          attrs: { type: "checkbox", id: idTheatre },
          domProps: {
            value: idTheatre,
            checked: Array.isArray(_vm.checked)
              ? _vm._i(_vm.checked, idTheatre) > -1
              : _vm.checked
          },
          on: {
            change: [
...
Vue.component('categories', __webpack_require__(/*! ./components/Categories.vue */ "./resources/js/components/Categories.vue"));
Vue.component('orders', __webpack_require__(/*! ./components/Orders.vue */ "./resources/js/components/Orders.vue"));
var app = new Vue({
  el: '#app'
}); //const app = new Vue({
//    el: '#app',
